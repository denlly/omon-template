	...
	<div id="app">
		<div class="main">
			<div class="sidebar-menu-con" :style="{
				...
				<shrinkable-menu :shrink="shrink" @on-change="handleSubmenuChange" :before-push="beforePush" :open-names="openedSubmenuArr" :theme="menuTheme" :accordion="accordion" :menu-list="menuList">
